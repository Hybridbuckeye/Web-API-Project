...
namespace Repository
{
    ...
    {
        //Typically this is where I would have my calls through the dbContext to access my data. This would also inherit from an Interface so I can easily apply Moq tests without using real data.
        //I'd probably use autofixture to apply test data for the unit tests implementation of the interface.        
        ...
        {
            Posts.Remove(Posts.SingleOrDefault(x => x.Id == id));
        }

        public void UpdatePost(Post post)
        {
            //This technically doesn't need to be done as long as domain object is being updated in uow. Save routine will handle the updating
        }
    }
}
